(function () {
    ...
    function t(key) {
        var labelsByLocale = {
            ...
            fr: {
                pageNav: 'Sections de la page éducation',
                models: 'Modèles',
                industrialCollege: 'Institut industriel',
                talentTraining: 'Formation des talents',
                teachingEquipment: 'Équipements pédagogiques',
                researchGlobal: 'R&D + international',
                contact: 'Contact',
                fourModels: 'Quatre modèles de coopération',
                introTitle: 'Choisissez un parcours de coopération visible, exploitable et évolutif.',
                introText: 'Longxiang organise la coopération formation-industrie autour de plateformes, du développement des talents, des équipements pédagogiques et de la recherche internationale.',
                bestFor: 'Adapté à',
                delivers: 'Ce que Longxiang fournit',
                outcomes: 'Résultats pour le partenaire',
                proofAlt: 'Image de coopération formation-industrie Longxiang',
                proofOverlay: 'Preuve de coopération',
                philosophy: 'Philosophie de coopération',
                discuss: 'Discuter de la coopération'
            },
            ru: {
