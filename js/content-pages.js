(function () {
    ...
    var FR_SOLUTIONS_TEXT_FALLBACKS = {
        'Solutions integrees d energie intelligente et de distribution electrique': 'Solutions intégrées d’énergie intelligente et de distribution électrique',
        'Transformer, appareillages, PV solaire, stockage d\'énergie, recharge EV, smart Micro-réseau, EPC, and O&M de lignes support for industriels et commerciaux power projets.': 'Transformateurs, appareillages, solaire PV, stockage d’énergie, recharge EV, microréseau intelligent, EPC et support O&M de lignes pour projets industriels et commerciaux.',
        'STORAGE & CHARGING': 'STOCKAGE ET RECHARGE',
        'Solutions par scenario de projet': 'Solutions par scénario de projet',
        'Longxiang organise ses équipements et son accompagnement autour des besoins r?els des projets afin d\'aider les acheteurs internationaux À valider l\'application, le périmètre fourni et les paramêtres de devis avant le choix du mod?le.': 'Longxiang organise ses équipements et son accompagnement autour des besoins réels des projets afin d’aider les acheteurs internationaux à valider l’application, le périmètre fourni et les paramètres de devis avant le choix du modèle.',
        'Support de livraison de projet from solution configuration to équipements supply, installation coordination, commissioning, and handover.': 'Support de livraison de projet depuis la configuration de la solution jusqu’à la fourniture des équipements, la coordination de l’installation, la mise en service et la remise du projet.',
        ...
        'Transformer, box substation, high- and low-voltage appareillages, compensation, protection, and monitoring équipements for stable site power.': 'Transformateurs, postes compacts, appareillages haute et basse tension, compensation, protection et équipements de supervision pour une alimentation stable du site.',
        'PV access, combiner, grid-connected cabinet, transformer, appareillages, metering, and monitoring support for distributed solar projets.': 'Raccordement PV, coffrets de regroupement, armoires de raccordement réseau, transformateurs, appareillages, comptage et supervision pour projets solaires distribués.',
        'Solar, wind, stockage d\'énergie, recharge EV, transformer, appareillages, and EMS coordination for load shifting and renewable energy use.': 'Coordination solaire, éolienne, stockage d’énergie, recharge EV, transformateurs, appareillages et EMS pour le décalage de charge et l’usage des énergies renouvelables.',
        'Source-grid-load-storage coordination for parcs industriels, weak-grid areas, islands, mines, and backup power scenarios.': 'Coordination source-réseau-charge-stockage pour les parcs industriels, zones à réseau faible, îles, mines et scénarios d’alimentation de secours.',
        'For Warm-Climate distribution projets': 'Pour les projets de distribution en climat chaud',
        'For early overseas inquiries, Longxiang focuses on clear technical matching instead of public MOQ or trade-term promises. Share the environment, voltage level, taille du projet, and équipements scope so engineers can review feasibility.': 'Pour les premières demandes internationales, Longxiang privilégie l’adéquation technique claire plutôt que des promesses publiques de MOQ ou de conditions commerciales. Partagez l’environnement, le niveau de tension, la taille du projet et le périmètre des équipements afin que les ingénieurs puissent vérifier la faisabilité.',
        'Middle East': 'Moyen-Orient',
        'Africa': 'Afrique',
        'Southeast Asia': 'Asie du Sud-Est',
        'parcs industriels, solar power access, commercial buildings, and stations de recharge where heat tolerance and low maintenance matter.': 'Parcs industriels, raccordement solaire, bâtiments commerciaux et stations de recharge où la tolérance à la chaleur et la faible maintenance sont importantes.',
        'distribution transformateurs, appareillages, and prets pour projet équipements for utility, industriel, campus, and public infrastructure needs.': 'Transformateurs de distribution, appareillages et équipements prêts pour projet destinés aux réseaux publics, sites industriels, campus et infrastructures publiques.',
        'Compact distribution systems, PV integration, recharge EV, and grid connection équipements for fast-growing sites.': 'Systèmes de distribution compacts, intégration PV, recharge EV et équipements de raccordement réseau pour sites à croissance rapide.',
        'Engineering Review': 'Revue technique',
        'Les sp?cifications personnalisées sont disponibles apr?s validation de la tension, de la capacité, de la charge et des exigences d\'installation.': 'Les spécifications personnalisées sont disponibles après validation de la tension, de la capacité, de la charge et des exigences d’installation.',
        'Contractant g?n?ral d\'ing?nierie (EPC)': 'Contractant général d’ingénierie (EPC)',
        'Coordinate residential and commercial distribution électrique engineering from équipements configuration to installation, commissioning, energization, and handover.': 'Coordonner l’ingénierie de distribution électrique résidentielle et commerciale, depuis la configuration des équipements jusqu’à l’installation, la mise en service, la mise sous tension et la remise du projet.',
        'distribution électrique engineering for residential communities, parcs industriels, and public facilities.': 'Ingénierie de distribution électrique pour les résidences, les parcs industriels et les équipements publics.',
        'Representative General Contracting References': 'Références représentatives de contractant général',
        'projet examples led by residential distribution électrique delivery, with station de recharge construction as complementary projet capability.': 'Exemples de projets axés sur la livraison de distribution électrique résidentielle, avec la construction de stations de recharge comme capacité complémentaire.',
        ...
        'Line Operation & Maintenance projets': 'Projets d’exploitation et de maintenance de lignes',
        ...
        'Configure transformateurs, box-type substations, high- and low-voltage appareillages, compensation, protection, and monitoring équipements as one practical distribution package for factories, parks, commercial buildings, substations, and new-energy projets.': 'Configurer transformateurs, postes compacts, appareillages haute et basse tension, compensation, protection et équipements de supervision comme un ensemble de distribution pratique pour usines, parcs, bâtiments commerciaux, postes et projets de nouvelle énergie.',
        'Adapt? aux usines, parcs industriels, bâtiments publics et postes de distribution.': 'Adapté aux usines, parcs industriels, bâtiments publics et postes de distribution.',
        'Coordination des paramêtres électriques, du niveau de protection et du périmètre de livraison.': 'Coordination des paramètres électriques, du niveau de protection et du périmètre de livraison.',
        'Avant devis, valider la capacité, la classe de tension, le type de charge, l?environnement d?installation, le niveau de protection, l?enveloppe et la norme de destination.': 'Avant devis, valider la capacité, la classe de tension, le type de charge, l’environnement d’installation, le niveau de protection, l’enveloppe et la norme de destination.',
        'Provide transformer, appareillages, distribution, grid connection, and monitoring équipements support for commercial and industriel photovoltaic projets.': 'Fournir le support en transformateurs, appareillages, distribution, raccordement réseau et équipements de supervision pour projets photovoltaïques commerciaux et industriels.',
        ...
        'C&I Wind + PV + ESS + recharge EV Solution': 'Solution C&I éolien + PV + ESS + recharge EV',
        'Integrates wind power, photovoltaic generation, stockage d\'énergie, recharge EV, and intelligent monitoring into one coordinated energy system.': 'Intègre production éolienne, génération photovoltaïque, stockage d’énergie, recharge EV et supervision intelligente dans un système énergétique coordonné.',
        ...
        'SEND EXIGENCES DU PROJET': 'ENVOYER LES EXIGENCES DU PROJET',
        'Energy Flow and System Topology': 'Flux d’énergie et topologie du système',
        'Connect renewable generation, stockage d\'énergie, transformer and appareillages systems, recharge EV terminals, and monitoring platforms in one controllable architecture.': 'Connecter génération renouvelable, stockage d’énergie, systèmes de transformateurs et d’appareillages, bornes de recharge EV et plateformes de supervision dans une architecture contrôlable.',
        ...
        'C&I Smart Micro-réseau Solution': 'Solution de microréseau intelligent C&I',
        'Build a controllable Micro-réseau that coordinates distributed generation, storage, grid access, industriel loads, and recharge EV demand.': 'Construire un microréseau contrôlable coordonnant la génération distribuée, le stockage, l’accès réseau, les charges industrielles et la demande de recharge EV.',
        ...
        'DISCUSS MICRO-RÉSEAU PROJET': 'DISCUTER DU PROJET DE MICRORÉSEAU',
        'recharge EV Station Construction': 'Construction de stations de recharge EV',
        'Combine AC chargers, DC fast chargers, high-power charging cabinets, stockage d\'énergie, transformer and appareillages systems, and operation monitoring for public stations de recharge, parcs industriels, logistics fleets, highway service areas, and commercial parking lots.': 'Combiner chargeurs AC, chargeurs rapides DC, armoires de recharge haute puissance, stockage d’énergie, systèmes de transformateurs et d’appareillages, et supervision d’exploitation pour stations de recharge publiques, parcs industriels, flottes logistiques, aires de service autoroutières et parkings commerciaux.',
        'Adapt? aux parkings commerciaux, d?p?ts de bus, stations publiques et sites industriels.': 'Adapté aux parkings commerciaux, dépôts de bus, stations publiques et sites industriels.',
        'Prise en charge de la s?lection technique, du sch?ma électrique et du support de mise en service.': 'Prise en charge de la sélection technique, du schéma électrique et du support de mise en service.',
        'Avant conception, valider le nombre de bornes, la puissance, l?implantation du parking, la capacité réseau, la facturation, la supervision et l?extension future.': 'Avant conception, valider le nombre de bornes, la puissance, l’implantation du parking, la capacité réseau, la facturation, la supervision et l’extension future.',
        'Sc?narios d\'application': 'Scénarios d’application',
        'Smart energy and projet service systems can be configured for multiple commercial, industriel, transportation, and public infrastructure environments.': 'Les systèmes d’énergie intelligente et de services projet peuvent être configurés pour de nombreux environnements commerciaux, industriels, de transport et d’infrastructures publiques.',
        'Public Buildings': 'Bâtiments publics',
        'commercial Complex': 'Complexe commercial',
        'industriel Park': 'Parc industriel',
        'Highway Facilities': 'Installations autoroutières',
        'Substation projets': 'Projets de postes',
        'Engineering Capability Behind Every Solution': 'Capacité d’ingénierie derrière chaque solution',
        'Longxiang\'s livraison de projet is supported by manufacturing qualifications, green factory recognition, and dedicated engineering research centers.': 'La livraison de projets Longxiang s’appuie sur des qualifications de fabrication, la reconnaissance d’usine verte et des centres de recherche d’ingénierie dédiés.',
        ...
        'Send projet Parameters for Configuration Review': 'Envoyer les paramètres du projet pour revue de configuration',
        'For a faster quotation, share the projet type, voltage level, load or capacity, grid-connected or off-grid mode, required solar/storage/charging scope, delivery boundary, and destination country.': 'Pour un devis plus rapide, partagez le type de projet, le niveau de tension, la charge ou la capacité, le mode raccordé réseau ou hors réseau, le périmètre solaire/stockage/recharge requis, la limite de livraison et le pays de destination.',
