    ...
    try {
        ...
        const rows = db.prepare(`
            SELECT
                ...
                p.seo_title, p.seo_title_ar, p.seo_title_fr, p.seo_title_ru,
                p.seo_description, p.seo_description_ar, p.seo_description_fr, p.seo_description_ru,
                p.seo_keywords, p.seo_keywords_ar, p.seo_keywords_fr, p.seo_keywords_ru,
                COALESCE(cover.path, '') AS cover_image,
    ...
    try {
        ...
        const createProduct = db.transaction(function () {
            ...
            const result = db.prepare(`
                INSERT INTO products
                    (
                        ...
                        seo_title, seo_title_ar, seo_title_fr, seo_title_ru,
                        seo_description, seo_description_ar, seo_description_fr, seo_description_ru,
                        seo_keywords, seo_keywords_ar, seo_keywords_fr, seo_keywords_ru,
            ...
            `).run({
                ...
                seo_title_ar: body.seo_title_ar ? String(body.seo_title_ar).trim() : '',
                ...
                seo_description_ar: body.seo_description_ar ? String(body.seo_description_ar).trim() : '',
                ...
                seo_keywords_ar: body.seo_keywords_ar ? String(body.seo_keywords_ar).trim() : '',
    ...
    try {
        ...
        const updateProduct = db.transaction(function () {
            ...
            `).run({
                ...
                seo_title_ar: body.seo_title_ar == null ? before.seo_title_ar : String(body.seo_title_ar).trim(),
                ...
                seo_description_ar: body.seo_description_ar == null ? before.seo_description_ar : String(body.seo_description_ar).trim(),
                ...
                seo_keywords_ar: body.seo_keywords_ar == null ? before.seo_keywords_ar : String(body.seo_keywords_ar).trim(),
