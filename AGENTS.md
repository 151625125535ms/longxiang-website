...
- [HANDOFF_TEMPLATE.md](docs/protocol/HANDOFF_TEMPLATE.md) — 方案审核请求模板（Codex 发给 Claude 时使用）
- [REVIEW_TEMPLATE.md](docs/protocol/REVIEW_TEMPLATE.md) — 方案审核意见模板（Claude 回填给 Codex 时使用）
