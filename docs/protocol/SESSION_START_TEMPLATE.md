...
| 角色 | 职责 |
|------|------|
| **Codex**（OpenAI Codex CLI） | 读取项目、设计方案、根据 Claude 审核意见修订方案，并在方案通过后执行 |
| **Claude** | 只审查 Codex 方案，指出风险、遗漏、边界问题和修改建议；不执行任务、不修改文件 |
