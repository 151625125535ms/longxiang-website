...
const product = {
    ...
    image: 'full-quality.jpg', cardImage: 'thumbnail.webp', categoryLabel: 'Oil', categoryLabelFr: 'Huile', capacities: ['100 kVA'], voltages: ['10 kV'], specs: [['Capacity', '100 kVA'], ['Standard', 'IEC 60076']]
};
...
const shell = '<html><head></head><body><section class="page-hero"><div class="breadcrumb"><span class="current" id="breadcrumb-product">Product</span></div><p id="page-title">Product</p><p id="page-subtitle">Details</p></section><main data-content-page="product-pages" data-product-page-kind="detail"><img id="main-product-image" src="" alt="" width="960" height="720" decoding="async" fetchpriority="high"><h1 id="product-title">Product</h1><div id="product-desc"></div><div data-product-decision-summary></div><div data-product-applications></div><div data-product-selection></div><h2 data-product-specs-title></h2><tbody id="specs-body"></tbody><div data-product-detail-support></div><div data-product-detail-faq></div><div data-product-related></div><aside data-product-detail-inquiry></aside></main><script src="js/product-detail.js"></script></body></html>';
