...
const contentBlock = { version: 26, body: { listingSupport: { title: 'Support', items: [] }, listingCta: { title: 'Contact', text: 'Project', button: { label: 'Send', href: 'contact.html' } } } };
